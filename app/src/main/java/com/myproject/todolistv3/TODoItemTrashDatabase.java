 ...
 */
public class TODoItemTrashDatabase extends SQLiteOpenHelper {
    ...
    public TODoItemTrashDatabase(Context context) {
    ...
    public List<ToDoItem> getAllTodoItemsFromTrash() {
        List<ToDoItem> todoItems = new ArrayList<ToDoItem>();
        // Select All Query
        String selectQuery = "SELECT  * FROM " + TABLE_TODO + " WHERE " + KEY_IS_DELETED + " = 1";
    ...
    public int getTodoItemCount() {
        String countQuery = "SELECT  * FROM " + TABLE_TODO + "WHERE" + KEY_IS_DELETED + " = 1";
        SQLiteDatabase db = this.getReadableDatabase();
